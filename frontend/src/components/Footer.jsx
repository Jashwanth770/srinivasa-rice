            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div className="col-span-1 md:col-span-1">
                        <Link to="/" className="inline-flex items-center gap-3 mb-4 bg-white p-2 pr-4 rounded-md">
                            <img src="/logo.png" alt="Sri Srinivasa Canvassing Logo" className="h-14 w-auto object-contain" />
                            <div className="flex flex-col">
                                <span className="font-bold text-xl leading-tight text-secondary">Sri Srinivasa</span>
                                <span className="text-sm font-semibold text-primary tracking-wider leading-tight">CANVASSING</span>
                            </div>
                        </Link>
                        <p className="text-gray-300 text-sm mb-4 leading-relaxed">
                            Premium Rice  Exporters from Sri Srinivasa Canvassing. We bridge the gap between quality Indian rice and global markets.
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-sm text-gray-300">
                            ...
                            <li><Link to="/market-rates" className="hover:text-primary transition-colors">Market Rates</Link></li>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-sm text-gray-300">
                            ...
                            <li className="flex items-center gap-3">
                                ...
                                <span>srinivasulu@srinivascanvassing.com</span>
                            </li>
                        </ul>
                    </div>
