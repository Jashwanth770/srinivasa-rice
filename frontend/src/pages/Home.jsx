                ...
                <div className="relative z-10 px-4 sm:px-6 lg:px-8">
                    ...
                    <form onSubmit={handleSubscribe} className="max-w-3xl mx-auto flex flex-col md:flex-row gap-4 justify-center items-center">
                        <input
                            ...
                            className="w-full md:w-64 px-5 py-4 rounded-xl text-gray-900 border-2 border-transparent focus:border-green-300 focus:ring-0 outline-none shadow-md font-medium text-lg placeholder-gray-400"
                        />
                        <div className="relative w-full md:w-80">
                            ...
                            <input
                                ...
                                className="w-full pl-16 pr-5 py-4 rounded-xl text-gray-900 border-2 border-transparent focus:border-green-300 focus:ring-0 outline-none shadow-md font-medium text-lg placeholder-gray-400"
                            />
                        </div>
                        <button
                            type="submit"
