        ...
        <div className="bg-background pt-10 pb-20">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="text-center mb-16">
                    ...
                    <p className="max-w-3xl mx-auto text-xl text-text-muted leading-relaxed animate-fade-in-up delay-100">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-20">
                    <div className="flex flex-col gap-6 w-full animate-fade-in-up delay-200">
                        <img
                            src="/about-mill.png"
                            alt="Advanced Rice Milling Facility"
                            className="rounded-lg shadow-xl w-full h-auto hover:-translate-y-2 hover:shadow-2xl transition-all duration-300"
                        />
                        <img
                    ...
                    <div className="space-y-6 text-lg text-gray-700 leading-relaxed animate-fade-in delay-300">
                        <p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 animate-fade-in-up delay-400">
                    <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 hover:-translate-y-2 hover:shadow-xl transition-all duration-300">
