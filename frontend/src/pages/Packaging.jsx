        ...
        <div className="bg-background pt-10 pb-20">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="text-center mb-16">
                    <h1 className="text-4xl font-extrabold text-secondary tracking-tight mb-4 animate-fade-in-up">Packaging & Logistics</h1>
                    <div className="w-24 h-1 bg-primary mx-auto rounded-full mb-6"></div>
                    <p className="max-w-2xl mx-auto text-xl text-text-muted animate-fade-in-up delay-100">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-16 mb-20">
                    ...
                    <div className="space-y-8 animate-fade-in-up delay-200">
                        ...
                        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-8 space-y-6 text-gray-700 hover:-translate-y-1 hover:shadow-lg transition-all duration-300">
                    ...
                    <div className="space-y-8 animate-fade-in-up delay-300">
                        ...
                        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-8 space-y-6 text-gray-700 hover:-translate-y-1 hover:shadow-lg transition-all duration-300">
                            ...
                            <div className="space-y-4">
                                <div className="flex items-center gap-4 bg-gray-50 p-4 rounded-lg border border-gray-100 hover:border-primary hover:bg-white transition-colors cursor-default">
