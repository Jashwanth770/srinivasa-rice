                        ...
                        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-8">
                            ...
                            <form onSubmit={handleAddProduct} className="flex flex-col md:flex-row gap-4 items-end">
                                <div className="flex-1 w-full">
                                    <label className="block text-sm font-medium text-gray-700 mb-1">Product / Variety Name</label>
                                    <input
                                        type="text"
                                        required
                                        value={newVariety.name}
                                        onChange={(e) => setNewVariety({ ...newVariety, name: e.target.value })}
                                        placeholder="e.g. Sona Masuri or 25kg PP Bag"
                                ...
                                <div className="flex-1 w-full md:max-w-xs">
                                    <label className="block text-sm font-medium text-gray-700 mb-1">Price (₹/MT or ₹/Bag)</label>
                                    <input
                                        type="number"
                                        step="0.01"
                                        required
                                ...
                                <table className="w-full text-left border-collapse">
                                    <thead>
                                        <tr className="bg-gray-50 border-b border-gray-200 text-xs uppercase tracking-wider text-gray-500 font-semibold">
                                            ...
                                            <th className="py-3 px-6">Product / Variety Name</th>
                                            <th className="py-3 px-6">Price (₹/MT or ₹/Bag)</th>
